...
HD_PWD='/home/adnaan/RealDigital _Projects/project2_rd/project2_rd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log req1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source req1.tcl
