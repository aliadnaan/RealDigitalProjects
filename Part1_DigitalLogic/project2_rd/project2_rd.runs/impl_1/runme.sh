...
HD_PWD='/home/adnaan/RealDigital _Projects/project2_rd/project2_rd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log req1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source req1.tcl -notrace
